...
//post new record
router.post('/categories/:categoryID/books/:bookID/reviews', verifyUser, async (req, res) => {
    try{
...
//update (PUT) record
router.put('/categories/:categoryID/books/:bookID/reviews/:reviewID', verifyUser, async (req, res) => {
...
//update (PATCH) record
router.patch('/categories/:categoryID/books/:bookID/reviews/:reviewID', verifyUser, async (req, res) => {
    const { categoryID, bookID, reviewID } = req.params;
...
// delete record
router.delete('/categories/:categoryID/books/:bookID/reviews/:reviewID', verifyUser, async (req, res) => {
    const { categoryID, bookID, reviewID } = req.params;
